...
13.	Note: The default Lambda execution timeout rate is 3 seconds. You may require more time for your function to execute – change it to 1 minute to make sure it has enough time. Also, if you are using this pipeline within a VPC, make sure you have selected it in the “Network” section of the Lambda function page.  
